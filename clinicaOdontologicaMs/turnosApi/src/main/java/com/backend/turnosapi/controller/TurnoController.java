package com.backend.turnosapi.controller;
...
public class TurnoController {
    ...
    public ResponseEntity<TurnoSalidaDto> registrarTurno(@Valid @RequestBody TurnoEntradaDto turnoEntradaDto) throws BadRequestException, UnirestException {
    ...
    @GetMapping("{id}")
    public ResponseEntity<TurnoSalidaDto> obtenerTurnoPorId(@PathVariable Long id) throws UnirestException {
    ...
    public ResponseEntity<?> eliminarTurno(@PathVariable Long id) throws ResourceNotFoundException, UnirestException {
